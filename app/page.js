      ...
      <dialog id="my_modal_3" className="modal">
        <div className="modal-box relative">
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="absolute w-14 right-0 bottom-4"
          >
            <path
          ...
          <p className="py-4">
            Thank you for pre-ordering from Larissa Gym Wear! We&apos;re excited
            to have you join our community of fitness enthusiasts. Your
            exclusive summer gym wear will be on its way soon.
          </p>
        </div>
      </dialog>
    </main>
